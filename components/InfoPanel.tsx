...
export default function InfoPanel({ feature }: Props) {
  if (!feature) {
    return (
      <div className="absolute bottom-3 left-3 z-[1000] bg-white p-4 rounded shadow border-slate-200">
        <p>Натисни обект</p>
      </div>
    )
  }
  ...
  const formattedRegion = visibleRegions.length > 0
    ...
    : null
  return (
    <div className="absolute bottom-3 left-3 z-[1000] bg-white p-4 max-w-sm border-slate-200">
